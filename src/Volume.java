...
public class Volume extends JFrame implements ActionListener {
    ...
    public Volume(){
        ...
        label3 = new JLabel("Enter the length:");
        ...
        label4 = new JLabel("Enter the width:");
        ...
        label5 = new JLabel("Enter the height:");
    ...
    public void actionPerformed(ActionEvent e) {
        float l = (float) Double.parseDouble(text1.getText());
        float w = (float) Double.parseDouble(text2.getText());
        float h = (float) Double.parseDouble(text3.getText());
        float volume = 0;
        if(e.getSource().equals(button)){
            volume = l*w*h;
            label2.setText(String.valueOf(volume+"cm3"));
